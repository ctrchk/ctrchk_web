...
| Lv.1 | 900, 900A, 966 |
| Lv.6 | 914, 966A |
| Lv.16 | 900S, 901P, 910, 914B |
| Lv.22 | 914H, 920, 966B |
| Lv.31 | 920X, 923, 966C |
| Lv.38 | 928, 929, 966T, 961, 961P |
| Lv.45 | 932, 935, 939, 939M, 962, 962A |
| Lv.51 | 955, 955A, 955H, 960, 962P, 962X, X935, S90, S91 |
...
### 🗺️ 3D 車道級動畫導航 (v2.1 新增)
CTRC HK 現已支援領先行業的 **3D 車道級動畫導航**：
- **3D 建築視圖**：導航時自動顯示 3D 建築物（fill-extrusion），提升空間感知與導航準確度。
- **高對比度引導**：針對不同主題（含黑金模式）優化的霓虹青色導航線與白色動畫流光。
- **車道級精度**：整合政府數據（GeoData.gov.hk）與自研將軍澳單車徑網絡，實現精確至車道的路徑貼附。
