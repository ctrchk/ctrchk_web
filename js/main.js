document.addEventListener('DOMContentLoaded', function() {
    ...
    const routes = [
        ...
        { id: '900S', alias: null, start: "調景嶺總站", end: "寶琳消防局", via: "將軍澳海濱、寶琳北路", nature: "旅遊", time: 40, length: "5.0km", difficulty: 3.5, image: "images/900S.jpg", description: "適合黃昏時分騎行的單向快速路線。從將軍澳海濱直達寶琳東，全程可欣賞日落美景，僅需 40 分鐘即可完成。", tags: ["將軍澳", "單向線", "寶琳調景嶺線", "黃昏日落", "快速", "少坡", "風景優美"], color: "#990000", gpx: [{ label: "往寶琳", file: "900S寶琳.gpx" }] },
        ...
        { id: '914B', alias: null, start: "寶琳(新都城二期)", end: "將軍澳醫院", via: "景林邨、坑口站、厚德邨", nature: "旅遊", time: 12, length: "3.0km", difficulty: 2, image: "images/914B.jpg", description: "一條連接寶琳新都城、坑口站與將軍澳醫院的旅遊路線。路況平坦，沿途接駁地鐵與巴士總站，提供便捷的醫院專線服務。", tags: ["將軍澳", "坑口北專線", "平坦", "醫院專線", "連接地鐵站", "連接巴士總站", "少坡"], color: "#073763", gpx: [{ label: "往寶琳", file: "914B寶琳.gpx" }, { label: "往醫院", file: "914B醫院.gpx" }] },
        ...
        { id: '939M', alias: null, start: "康城站", end: "將軍澳創新園", via: "環保大道", nature: "通勤", time: 35, length: "2.9km(單向)", difficulty: 3.5, image: "images/939M.jpg", description: "連接康城站及創新園的特快通勤路線。路面平坦，專為通勤族設計，讓你可以由創新園快速轉乘地鐵。", tags: ["將軍澳", "通勤專線", "平坦", "快速", "創新園路線", "連接地鐵站", "人流較少", "循環"], color: "#741b47", gpx: [{ label: "往康城", file: "939M康城.gpx" }, { label: "往創新園", file: "939M循環.gpx" }] },
        ...
        { id: '955H', alias: "靈實專線", start: "寶琳站", end: "靈實醫院(九巴車廠)", via: "寶琳北路", nature: "混合", time: "20(來回)", length: "3.1km(來回)", difficulty: 1.5, image: "images/955H.jpg", description: "連接寶琳站與靈實醫院的平坦特快路線。適合通勤與旅遊，為需要前往醫院的用戶提供便利。", tags: ["將軍澳", "平坦", "醫院專線", "連接地鐵站", "通勤", "旅遊"], color: "#dd7e6b", gpx: [{ label: "來回", file: "955H循環.gpx" }] },
        ...
        { id: '961', alias: null, start: "維景灣畔", end: "康城西", via: "調景嶺站、唐賢街、至善街、怡明邨、北橋、康城海濱", nature: "混合", time: 30, length: "4.7km", difficulty: 3, image: "images/961.jpg", description: "一條連接康城與調景嶺維景灣畔的快速路線。路況少坡，讓康城居民可以方便地前往將軍澳中部。", tags: ["將軍澳", "少坡", "維景灣畔專線", "風景優美", "通勤", "旅遊"], color: "#93c47d", gpx: [{ label: "往康城", file: "961康城.gpx" }, { label: "往調景嶺", file: "961調景嶺.gpx" }] },
        { id: '961P', alias: null, start: "康城西", end: "將軍澳中心", via: "康城海濱、南橋、將軍澳海濱", nature: "旅遊", time: 20, length: "3.0km", difficulty: 3, image: "images/961P.jpg", description: "只於黃昏前後開放的單向騎行路線。從日出康城近大橋出發，途經南橋及將軍澳南梯台前往將軍澳中心，沿著海濱欣賞日落，最後前往將軍澳中心商場，亦可接駁渡輪前往。", tags: ["將軍澳", "旅遊專線", "黃昏日落", "單向", "海濱專線", "接駁渡輪", "快速"], color: "#93c47d", gpx: [{ label: "單向", file: "961P將軍澳.gpx" }] },
        ...
        { id: '966C', alias: "峻瀅至調景嶺站", start: "峻瀅", end: "調景嶺站", via: "日出康城、將軍澳跨灣大橋", nature: "通勤", time: 22, length: "3.8km", difficulty: 4, image: "images/966C.jpg", description: "一條連接峻瀅/日出康城與調景嶺站的特快通勤路線。取道將軍澳跨灣大橋直接連接兩地，方便峻瀅及康城居民前往調景嶺或快速轉乘地鐵。", tags: ["將軍澳", "通勤專線", "多坡", "大橋特快", "連接地鐵站", "連接巴士總站", "康城專線"], color: "#ff9900", gpx: [{ label: "往康城", file: "966C康城.gpx" }, { label: "往調景嶺", file: "966C調景嶺.gpx" }] },
        { id: '966T', alias: "康城站至調景嶺站", start: "調景嶺站", end: "康城站", via: "將軍澳跨灣大橋", nature: "旅遊", time: 16, length: "3.0km", difficulty: 3, image: "images/966T.jpg", description: "專為遊覽觀光設計的大橋特快路線。連接康城站與調景嶺站，適合單車新手挑戰自我，欣賞大橋景色。", tags: ["將軍澳", "旅遊專線", "多坡", "大橋特快", "新手必試", "連接地鐵站"], color: "#ff9900", gpx: [{ label: "往康城", file: "966T康城.gpx" }, { label: "往調景嶺", file: "966T調景嶺.gpx" }] },
        { id: 'S90', alias: "清水灣半島至將軍澳站", start: "清水灣半島", end: null, via: "康城海濱", nature: "通勤", time: 20, length: "3.5km(來回)", difficulty: 2.5, image: "images/S90.jpg", description: "清水灣半島專線，連接將軍澳站。路況少坡，適合通勤，為居民提供一條快速的地鐵接駁選擇。", tags: ["將軍澳", "通勤專線", "少坡", "特快", "清水灣半島專線", "連接地鐵站"], color: "#00ff00", textColor: "black", gpx: [{ label: "來回", file: "S90康城循環.gpx" }] },
        ...
        // 沙田區規劃中路線
        { id: 'ST-01', alias: null, start: "沙田站", end: "第一城", via: "城門河畔", nature: "通勤", time: "待定", length: "待定", difficulty: "待定", image: "images/st_coming_soon.jpg", description: "規劃中的沙田路線，敬請期待！", tags: ["沙田區", "通勤"], color: "#333", link: "/coming_soon.html", gpx: [] }
    ];
        ...
        function renderRoutes(routesToRender) {
            ...
            if (routesToRender.length > 0) {
                routesToRender.forEach(route => {
                    const card = document.createElement('div');
                    card.className = 'route-card-full';
