...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const routes = [
        ...
        { id: '914B', alias: "坑口北急速線", start: "寶琳(新都城二期)", end: "將軍澳醫院", via: "景林邨、坑口站、厚德邨", nature: "旅遊", time: 12, length: "3.0km", difficulty: 2, image: "images/914B.jpg", description: "一條連接寶琳新都城、坑口站與將軍澳醫院的旅遊路線。路況平坦，沿途接駁地鐵與巴士總站，提供便捷的醫院專線服務。", tags: ["將軍澳", "坑口北專線", "平坦", "醫院專線", "連接地鐵站", "連接巴士總站", "少坡"], color: "#073763", gpx: [{ label: "往寶琳", file: "914B寶琳.gpx" }, { label: "往醫院", file: "914B醫院.gpx" }] },
