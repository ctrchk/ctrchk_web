...
export const PERMISSION_DEFS = [
  ...
  { id: 7, key: 'map_cycparkspace', rank: 'bronze', label: 'CYCPARKSPACE 全港單車泊位圖層' },
  { id: 8, key: 'theme_silver', rank: 'silver', label: '銀色閃耀 UI 主題與動態頭像框（銀白微發光圈）' },
  { id: 9, key: 'nav_multistop', rank: 'silver', label: '多站點自訂路線規劃（最多 5 站）' },
  { id: 10, key: 'weather_heavy_rain_alert', rank: 'silver', label: '突發暴雨預警優先推送與警告' },
  ...
  { id: 17, key: 'theme_gold', rank: 'gold', label: '極簡黑金版地圖皮膚與黑金主題（3D 黑曜石流金框）' },
