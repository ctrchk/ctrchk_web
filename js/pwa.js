...
(function () {
  ...
  const PERMISSION_DEFS = [
    ...
    { id: 7, key: 'map_cycparkspace', rank: 'silver', label: 'CYCPARKSPACE 單車泊位圖層（銀/金卡）' },
    { id: 8, key: 'theme_silver', rank: 'silver', label: '銀色介面主題（銀/金卡）' },
    { id: 9, key: 'nav_multistop', rank: 'silver', label: '多站點自訂路線規劃（最多 5 站，銀/金卡）' },
    { id: 10, key: 'weather_heavy_rain_alert', rank: 'silver', label: '惡劣天氣提醒（銀/金卡，規劃中）' },
    { id: 11, key: 'poster_no_watermark', rank: 'silver', label: '高清海報（減少水印，銀/金卡）' },
    { id: 12, key: 'coin_bonus_silver', rank: 'silver', label: '里程幣收益永久加成 +5%（銀/金卡）' },
    { id: 13, key: 'map_issue_report', rank: 'silver', label: '路面維修/障礙標記權（銀/金卡）' },
    { id: 14, key: 'weekly_efficiency_report', rank: 'silver', label: '週度騎行效率分析（銀/金卡，規劃中）' },
    { id: 15, key: 'discord_silver_role', rank: 'silver', label: 'Discord「銀色破風手」身分組（銀/金卡）' },
    { id: 16, key: 'map_3d_gold', rank: 'gold', label: '進階地圖視覺（金卡，規劃中）' },
    { id: 17, key: 'theme_gold', rank: 'gold', label: '金卡專屬黑金介面主題' },
    { id: 18, key: 'poster_gold_copy', rank: 'gold', label: '海報進階文案樣式（金卡）' },
    { id: 19, key: 'coin_bonus_gold', rank: 'gold', label: '里程幣收益永久加成 +15%（金卡）' },
    { id: 20, key: 'route_naming_rights', rank: 'gold', label: '路線建議命名提案（金卡，提交審核）' },
    { id: 21, key: 'weather_radar_5min', rank: 'gold', label: '5 分鐘降雨雷達（金卡，規劃中）' },
    { id: 22, key: 'beta_priority', rank: 'gold', label: '新功能 Beta 優先體驗（金卡）' },
    { id: 23, key: 'discord_emergency', rank: 'gold', label: '客服快速協助通道（金卡，規劃中）' },
    { id: 24, key: 'weekend_double_preview', rank: 'gold', label: '週末雙倍里程活動優先通知（金卡）' },
    { id: 25, key: 'discord_gold_role', rank: 'gold', label: 'Discord「黃金領騎」稱號及身份組（金卡）' },
  ];
